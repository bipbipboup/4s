	...
	else if( bSVR == SVR_MAP )
	{
		...
		if( it != m_mapPendingMapSession.end() )
		{
			...
			if( pNEWSESSION )
			{
				...
				pNEWSESSION->m_bLogicalValid = FALSE; // CS_CONNECT_ACK�� �ޱ������� �� ������ ������ ��ȿ�ص� ����ؼ��� �ȵȴ�.
							  ...
							  BOOL bInsertStack)
{
	...
	case TMSGBOXOPEN_CLOSEALL_ALREADY: // ������ �����ִ� ��� �޽��� �ڽ��� ���� ���� ��Ű�� ���� �� �޽����ڽ��� ����.
		{
			ClearMessageBox();
